                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                         ...
                         text("Player 1 " + allPlayers.player1.name, player1.position.x - 50, player1.position.y + 30);
                         text("Player 2 " + allPlayers.player2.name, player2.position.x - 50, player2.position.y + 30);
